...
# ── Chat models ──
CHAT_PROVIDERS = {
    "openai": ["gpt-4o", "gpt-4o-mini", "gpt-4.1", "gpt-4.1-mini", "gpt-4.1-nano", "o1", "o1-mini", "o3-mini", "o4-mini"],
...
# ── Video gen constants ──
VIDEO_MODELS = ["sora-2", "sora-2-pro", "veo-3.0-generate-001"]
VIDEO_MODEL_LABELS = {
    "sora-2": "Sora 2",
    "sora-2-pro": "Sora 2 Pro",
    "veo-3.0-generate-001": "Gemini Veo 3.0",
}
VIDEO_MODEL_PROVIDER = {
    "sora-2": "openai",
    "sora-2-pro": "openai",
    "veo-3.0-generate-001": "gemini",
}
...
# ── Image gen constants ──
IMAGE_MODELS = ["gpt-image-1", "dall-e-3", "imagen-3.0-generate-002"]
IMAGE_MODEL_LABELS = {
    "gpt-image-1": "GPT Image 1",
    "dall-e-3": "DALL-E 3",
    "imagen-3.0-generate-002": "Gemini Imagen 3.0",
}
...
TTS_VOICES_EXTENDED = ["alloy", "ash", "ballad", "coral", "echo", "fable", "nova", "onyx", "sage", "shimmer", "verse"]

def get_tts_voices(model: str) -> list[str]:
    """gpt-4o-mini-tts has 2 extra voices: ballad, verse"""
    if model == "gpt-4o-mini-tts":
        return TTS_VOICES_EXTENDED
    return TTS_VOICES
